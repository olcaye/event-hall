...
<main class="py-5" style="min-height: 100%">
    @yield('content')
</main>

<footer class="w-full bg-black text-white py-4 text-center mt-auto">
    <p class="text-sm">&copy; {{ date('Y') }} Tüm hakları saklıdır.</p>
</footer>
